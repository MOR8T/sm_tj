...
import phone from "@/public/second phone.svg";
...
const Fourth = () => {
  ...
  return (
    <section className="md:max-w-[1300px] w-[90%] m-auto py-10 flex items-start justify-between md:flex-row flex-col md:gap-0 gap-8">
      <div className="md:w-[421px] md:h-[510px] relative flex flex-col justify-between md:gap-0 gap-8">
        <div className="flex flex-col items-start gap-1">
          <h2 className="text-[rgb(31,41,55)] text-2xl font-semibold">
            {t("fourth_section_heading")}
          </h2>
          <p className="text-[#4B5563]">{t("fourth_section_description")}</p>
          <button className="text-[#315266] text-[14px] font-semibold">
            {t("fourth_section_button")}
          </button>
        </div>
      ...
      {/* /// */}
      <div className="md:w-[500px] flex items-end justify-between md:flex-row flex-col md:gap-0 gap-5">
        ...
        <div className="p-5 md:w-[40%] border-1 rounded-xl border-[#E7E8EB]">
          <h2 className="text-[#1F2937]">{t("description_box")}</h2>
        </div>
      </div>
    </section>
  );
